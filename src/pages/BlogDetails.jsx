            ...
            <Col lg="8" md="8">
              <div className="blog__details">
                ...
                <h6 className='ps-5 fw-normal'>
                  <blockquote className='fs-4'></blockquote>{blog.quote}
                </h6>
                <p className="section__description">{blog.description}</p>
              </div>
              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    ...
                    <p className="section__description mb-0">08 December, 2022</p>
                    <p className="section__description">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Quidem nulla labore natus beatae est quae.
                      Animi exercitationem natus voluptate beatae ad ipsum consequuntur architecto quidem deserunt at,
                      temporibus reiciendis dicta.
                    </p>

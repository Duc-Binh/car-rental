        ...
        <Row>
          <Col lg="6" md="6" sm="6">
            <div className="header__top__left">
              ...
              <span className="header__top__help">
                <i class="ri-phone-fill"></i>+84-344-662-285
              </span>
            </div>
          </Col>
          ...
          <Col lg="6" md="6" sm="6">
              <div className="header__top__right d-flex align-item-center justify-content-end gap-3">
                <Link to="#" className='d-flex align-item-center gap-1'>
      ...
      <div className="header__middle">
        <Container>
          <Row>
            ...
            <Col lg="3" md="3" sm="4">
              <div className="header__location d-flex align-item-center gap-2">
                <span><i class="ri-earth-line"></i></span>
                <div className="header__location-content">
                  <h4>VietNam</h4>
                  <h6>Hà Nội City, Việt Nam</h6>
                </div>
              </div>
            </Col>
